  ...
  if (document.getElementById("subscribe-box") !== null) {
    ...
    const subscribe = async function () {
      ...
      if (!validateEmail(input)) {
        ...
        document.querySelector("#subscribe-box .error-message").textContent =
          getResponse.message;
        document
          .querySelector("#subscribe-box .error-message")
          .classList.add("active");
    ...
    document
      .querySelector('#subscribe-box input[type="submit"]')
    ...
    document
      .querySelector('#subscribe-box input[type="text"]')
